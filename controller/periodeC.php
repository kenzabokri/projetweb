...
require 'C:\xampp\htdocs\projet_gestion_cours_categorie_hejer\config3.php';

require 'C:\xampp\htdocs\projet_gestion_cours_categorie_hejer\model\periode.php';
...
class PeriodeC
{
    ...
    {
        $sql = "INSERT INTO periode VALUES (NULL, :longueur)";
        $db = con::getConnexion();
        try {
