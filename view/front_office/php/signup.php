<?php
    ...
    User_control::add_user($db,$firstName,$lastName,$username,$mail,$role,$description,$password);
...
<section style="background-image: url(../../images/bg2.jpg);text-align:center;">
<pre>
    ...
    <div style="color:black;text-align:center;font-size:50px" >
        <h2 class="titre-text">Registered successfully</h2>
    </div>
    ...
    <div class="contactform">
        <h3>Connecter</h3>
        <form action="./login/login.php" method="post" id="f1">
            <div class="inputboite">
                <input type="text" placeholder="userName or Mail" name="user" id="user">
            </div>
            <div class="inputboite">
               <input type="password" placeholder="mot de passe" name="password" id="password">
            </div>
            <div class="inputboite">
                <button class="btn-reserve" id="submit-btn1" type="submit" onclick="return verify11()">Login</button>
            </div>
        </form>
