...
<header>
    ...
    <ul class="navbar">
        ...
        <li><a href="<?php echo $url1?>" onclick="toggleMenu();">Lessons</a></li>
        <li><a href="#menu" onclick="emploi()">Schedule</a></li>
        <li><a href="#apropos" onclick="updatePinfo();">Update info</a></li>
        <pre>                                                                                                                                                      </pre>
