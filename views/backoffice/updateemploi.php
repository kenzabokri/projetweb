...
<form action="" method="POST" onsubmit="return validateForm();">
            <table border="1" align="center">
                ...
                <tr>
                    <td>
                        <label for="seance">seance:
                        </label>
                    </td>
                    <td><input type="text" name="seance" id="seance" value="<?php echo $emploi['seance']; ?>" maxlength="300"></td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <label for="idclasse">idclasse:
                        </label>
                    </td>
                    <td><input type="text" name="idclasse" id="idclasse" value="<?php echo $emploi['idclasse']; ?>"></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
